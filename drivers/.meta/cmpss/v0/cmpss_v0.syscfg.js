...
let numberOfInstance = device_peripheral.numberOfInstance;
let CMPSS_INSTANCE = device_peripheral.CMPSS_INSTANCE;
...
let cmpssModule = {
    ...
    moduleStatic : {
        name : "cmpssGlobal",
        displayName : "CMPSS Global Settings",
        config : [],
        sharedModuleInstances : (inst) =>{
            return [
                {
                    moduleName : soc_ctrl.getSocCtrlSubModulePath("soc_ctrl_cmpss"),
                    name : "cmpssSettings",
                    displayName : "CMPSS Settings",
                },
            ]
        },
        modules : function (){
